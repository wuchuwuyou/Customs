...
@interface MWSMJGChapterViewController ()

@end

@implementation MWSMJGChapterViewController
...
//        [self loadDetailDataWithModel:model];
    ...
    [vm subtitle:model.TARIFF_NO keyword:nil name:model.TARIFF_NAME];
    MWSMJGSectionViewController  *vc = [[MWSMJGSectionViewController alloc] initWithStyle:UITableViewStylePlain];
    vc.viewModel = vm;
