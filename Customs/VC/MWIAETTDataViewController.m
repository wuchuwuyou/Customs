...
@interface MWIAETTDataViewController ()
...
@implementation MWIAETTDataViewController
...
//    [self.headerView setLeftTitle:NSLocalizedString(@"tariff_no", nil) mid:NSLocalizedString(@"goods_name", nil) right:NSLocalizedString(@"general_tariff", nil)];
    [self.headerView setLeftTitle:NSLocalizedString(@"tariff_no", nil) right:NSLocalizedString(@"goods_name", nil)];
...
//    [cell configCellWithLeft:m.CODE_TS mid:m.G_NAME right:m.COMM_RATE];
    [cell configCellWithLeftTitle:m.CODE_TS right:m.G_NAME];
